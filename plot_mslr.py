...
# D1 = Plotting.read_dir("./results/mslr30k_12k_rucb/")
# D1 = Plotting.read_dir("./results/mslr30k_12k_best/")
# D1 = Plotting.read_dir("./results/mslr30k_rucb_best_30k/")
...
if Args.save:
    plt.savefig("./figs/plots_mslr30k.png", format='png', dpi=500, bbox_inches='tight')
    plt.savefig("./figs/plots_mslr30k.pdf", format='pdf', dpi=500, bbox_inches='tight')
else:
    plt.show()
